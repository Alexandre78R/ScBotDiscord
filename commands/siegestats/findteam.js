...
function buildSuccessfulMessage(result, newParam, message, infoUser) {
    ...
    for (let n = 0; n < tabObject.length; n++) {
        ...
        for (let j = 0; j < listUserTabObject.length; j++) {
            ...
            if (newListUserOrderLimit3.length <= 3) {
    ...
    for (let i = 0; i < tabListTabResult.length; i++) {
        ...
        .setDescription(`${infoUser.username}, liste de team sur ${newParam === "off" ? "l'offense" : "la défense"} avec :`)
        ...
        if (monsterList != "invalid") {
            ...
            if (newParam === "off") {
                ...
                if (result.length == 0) {
                    ...
                    //     }
                    // }
                    var succesMessage = buildSuccessfulMessage(result, newParam, message, infoUser);
