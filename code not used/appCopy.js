...
// console.log('Liste des joueur', tableauResultat.Joueurs[1])
// if(tableauResultat.Joueurs == "Nardax"){
// console.log("Trouvé !")
// }else{
// console.log("Pas trouver")
// }
// for (let n = 0; n < tableauResultat.Joueurs.length; n++) {
//     console.log("Joueur", tableauResultat.Joueurs[n])
// }
// console.log("Liste des Joueur :", JSON.stringify(tableauResultat.Joueurs))
// var JSONJOUEUR = JSON.stringify(tableauResultat.Joueurs);

// for (let test = 0; test < JSONJOUEUR.length; test++) {
//     console.log("test Tableau Joueur", JSONJOUEUR[test])
// }
